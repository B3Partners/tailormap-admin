...
<stripes:layout-render name="/WEB-INF/jsp/templates/ext.jsp">
    ...
    <stripes:layout-component name="body">
        <stripes:form beanclass="nl.tailormap.viewer.admin.stripes.ApplicationTreeLayerActionBean" id="apptreelayerform" class="maximize">
            ...
            <div id="tabs" class="maximize">
                ...
                <div id="context-tab" class="tabdiv">
                    ...
                    <stripes:textarea cols="80" rows="5" name="details['context']" id="context_textarea" class="extliketextarea" />
                ...
                Ext.onReady(function() {
                    Ext.create('vieweradmin.components.ApplicationTreeLayer', {
                        ...
                        actionBeans: {
                            ...
                            attributesURL: <js:quote><stripes:url beanclass="nl.tailormap.viewer.admin.stripes.AttributeActionBean" event="getGridData"/></js:quote>,
                            getDBValuesUrl: <js:quote><stripes:url beanclass="nl.tailormap.viewer.admin.stripes.ApplicationTreeLayerActionBean" event="getUniqueValues"/></js:quote>
                        }
                    })
                });
            </script>
