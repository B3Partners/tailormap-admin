...
export const selectComponentsConfigLoadStatus = createSelector(selectAdminCoreState, state => state.applicationConfigLoadStatus);
...
export const selectStyleConfig = createSelector(selectAdminCoreState, state => state.styleConfig || {});
